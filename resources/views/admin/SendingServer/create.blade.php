                            ...
                            <div class="card-body">
                                ...
                                @switch($server['settings'])
                                    ...
                                    @case('ClickatellCentral')
                                        <p>{!!  __('locale.description.clickatell') !!} {{config('app.name')}}. For Inbound Message Here is the Callback URL: <code>{{ route('inbound.clickatell') }}</code></p>
                                        @break
                                    ...
                                    @case('Infobip')
                                        <p> {!! __('locale.description.infobip') !!}. For Inbound Message Here is the Callback URL: <code>{{ route('inbound.infobip') }}</code></p>
                                        @break
                                    ...
                                    @case(SendingServer::TYPE_WHATSAPP)
                                        <p> You will find the Language code here <a href="https://developers.facebook.com/docs/whatsapp/api/messages/message-templates/" target="_blank">View a list of supported languages for message templates.</a></p>
                                        @break
                                    ...
                                    @case('Inteliquent')
                                        <p>To receive inbound message please update this url on your inbound Callback URL {{ route('inbound.inteliquent') }}</p>
                                        @break

                                    @case(SendingServer::TYPE_CLICKSEND)
                                        <p>For Inbound Message Here is the Callback URL: <code>{{ route('inbound.clicksend') }}</code></p>
                                        @break
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MESSAGEBIRD || $server['settings'] == SendingServer::TYPE_INFOBIP || $server['settings'] == SendingServer::TYPE_TELNYX || $server['settings'] == SendingServer::TYPE_BULKSMSPROVIDERNG || $server['settings'] == SendingServer::TYPE_AIRTELINDIA)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="voice_api_link">Voice API Link</label>
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MESSAGEBIRD || $server['settings'] == SendingServer::TYPE_TEXTLOCAL || $server['settings'] == SendingServer::TYPE_SMSGLOBAL || $server['settings'] == SendingServer::TYPE_TXTRIA || $server['settings'] == SendingServer::TYPE_TELEAPI || $server['settings'] == SendingServer::TYPE_BULKREPLY)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="mms_api_link">MMS API Link</label>
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MESSAGEBIRD)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="whatsapp_api_link">Whatsapp API Link</label>
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MSG91 || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="otp_api_link">OTP API Link</label>
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MESSAGGIO)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-select" id="sms_type" name="sms_type">
                                                        <option value="promotion" {{ $server['sms_type'] == 'promotion' ? 'selected': null }}>Promotional</option>
                                                        <option value="transaction" {{ $server['sms_type'] == 'transaction' ? 'selected': null }}>Transactional</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MOCEANAPI)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="api_secret"
                                                           class="form-control @error('api_secret') is-invalid @enderror"
                                                           value="{{ $server['api_secret'] }}" name="api_secret" required>
                                                    @error('api_secret')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap col-12">
                                            ...
                                            @if($server['type'] != 'whatsapp' && $server['type'] != 'viber')
                                            ...
                                            @if($server['settings'] == SendingServer::TYPE_MESSAGGIO || $server['type'] == 'viber')
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div class="form-check form-switch form-check-primary">
                                                        ...
                                                        <input type="checkbox" class="form-check-input" value="1" id="viber" name="viber" {{ $server['viber'] ? 'checked': null }}>
                                            ...
                                            @if($server['settings'] == SendingServer::TYPE_MSG91 || $server['settings'] == SendingServer::TYPE_SMARTSMSSOLUTIONS || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT  || $server['settings'] == SendingServer::TYPE_FAST2SMS || $server['type'] == 'otp')
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div class="form-check form-switch form-check-primary">
                                                        ...
                                                        <input type="checkbox" class="form-check-input" value="1" id="otp" name="otp" {{ $server['otp'] ? 'checked': null }}>
