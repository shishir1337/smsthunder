                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @elseif($gateway->type == PaymentMethods::TYPE_PAYHERELK)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="secret" name="app_id" class="form-control" value="{{ $gateway->getOption('app_id') }}" required>
                                                    @error('app_id')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="app_secret" class="form-label required">APP Secret</label>
                                                    <input type="text" id="secret" name="app_secret" class="form-control" value="{{ $gateway->getOption('app_secret') }}" required>
                                                    @error('app_secret')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        @elseif($gateway->type == PaymentMethods::TYPE_EASYPAY)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="account_id" class="form-label required">Account ID</label>
                                                    <input type="text" id="account_id" name="account_id" class="form-control" value="{{ $gateway->getOption('account_id') }}" required>
                                                    @error('account_id')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="merchant_key" class="form-label required">Merchant identification key</label>
                                                    <input type="text" id="merchant_key" name="merchant_key" class="form-control" value="{{ $gateway->getOption('merchant_key') }}" required>
                                                    @error('merchant_key')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                        ...
                                        @elseif($gateway->type == PaymentMethods::TYPE_SELCOMMOBILE)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="vendor" name="vendor" class="form-control" value="{{ $gateway->getOption('vendor') }}" required>
                                                    @error('vendor')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="api_secret" class="form-label required">API Secret</label>
                                                    <input type="text" id="api_secret" name="api_secret" class="form-control" value="{{ $gateway->getOption('api_secret') }}" required>
                                                    @error('api_secret')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        @elseif($gateway->type == PaymentMethods::TYPE_CASH)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea rows="7" class="form-control" id="payment_details" name="payment_details" required>{!! $gateway->getOption('payment_details') !!}</textarea>
