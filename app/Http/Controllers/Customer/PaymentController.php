                ...
                case PaymentMethods::TYPE_COINPAYMENTS:
                    ...
                    if ($paymentMethod) {
                        ...
                        $invoice = Invoices::create([
                                ...
                                'type'           => Invoices::TYPE_SUBSCRIPTION,
                                'description'    => 'Payment for sms top up',
                                'transaction_id' => $user->id.'_'.$request->get('sms_unit'),
                                'status'         => Invoices::STATUS_PAID,
                        ]);
                    ...
                    if (isset($pollurl)) {
                        ...
                        if ($paymentMethod) {
                            ...
                            $paynow = new Paynow(
                                    ...
                                    $credentials->integration_key,
                                    route('customer.callback.paynow'),
                                    route('customer.top_up.payment_success', ['user_id' => $user->id, 'sms_unit' => $request->get('sms_unit')])
                            );
